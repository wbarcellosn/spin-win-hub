...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CXHWau4T.mjs");
...
const manifest = {
  "1d5154eba6fa00ac95e815449ea093f347b48563c33bbbb067ece453f3b9060b": {
    functionName: "adminListWheelPrizes_createServerFn_handler",
    importer: () => import("./admin.functions-AuVM3LKS.mjs")
  },
  "44954dc1e88408f4a289504814e6c703f0e8f510cdcd42f5cb9d4e396e5bae44": {
    functionName: "getEntryByCpf_createServerFn_handler",
    importer: () => import("./wheel.functions-CW21cqwa.mjs")
  },
  "62a09630ae892efc99d847cbb74d9a2e477d75d16edda2abe1140389189deccf": {
    functionName: "adminResetSpin_createServerFn_handler",
    importer: () => import("./admin.functions-AuVM3LKS.mjs")
  },
  "8110b640fbabe7b99a6b84747433f9bf498ae415f0f4b203e0076410d9c92c27": {
    functionName: "adminIsAdmin_createServerFn_handler",
    importer: () => import("./admin.functions-AuVM3LKS.mjs")
  },
  "87570d6a0d7691dda0076084293ef336b17911fe92d43e09e9a67ee737cba380": {
    functionName: "adminMarkVrUsed_createServerFn_handler",
    importer: () => import("./admin.functions-AuVM3LKS.mjs")
  },
  "8b404eadc272d7d27f48745f2fd105c6bc74772c80d7e5eb87638d43cd197daa": {
  ...
  "91701904c4a88c998a107866d8807127df76cc1972c1e81307f1eaadfb29db74": {
    functionName: "adminListEntries_createServerFn_handler",
    importer: () => import("./admin.functions-AuVM3LKS.mjs")
  },
  "a0184961e7d75500479c7fa26bae229ea863e37aaab3dbe9d93e7d57038a20b9": {
    functionName: "getWheelPrizes_createServerFn_handler",
    importer: () => import("./wheel.functions-CW21cqwa.mjs")
  },
  "aec28097a9b8c76b2cdefd0afd6e15475526a298afcf7e8bf06de95eb9770d84": {
    functionName: "submitForm_createServerFn_handler",
    importer: () => import("./wheel.functions-CW21cqwa.mjs")
  },
  "b0732aed35a213098fc32a2935a5f408e321083ddd7f0ca0c6f4c128ad0eb973": {
    functionName: "recordSpin_createServerFn_handler",
    importer: () => import("./wheel.functions-CW21cqwa.mjs")
  },
  "ee833e4f45be3fcc98c6b8a8c97b04e32f93e9bf81c1f77fad047726ba34e147": {
    functionName: "adminSaveWheelPrizes_createServerFn_handler",
    importer: () => import("./admin.functions-AuVM3LKS.mjs")
  },
  "f2a46cde8c4c87131db02fddf9f22b85b49c65c55c3dd48fe73360a61fa91916": {
    functionName: "getEntry_createServerFn_handler",
    importer: () => import("./wheel.functions-CW21cqwa.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-H4UB40XY.mjs"),
    import("./start-BxPkkf6E.mjs"),
